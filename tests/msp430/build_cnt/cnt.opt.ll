...
for.body3:                                        ; preds = %for.body, %for.inc
  ...
  %arrayidx4 = getelementptr inbounds nuw [10 x i16], ptr %Array, i16 %OuterIndex.02, i16 %InnerIndex.01, !dbg !62
...
for.body3:                                        ; preds = %for.body, %for.inc
  ...
  %arrayidx4 = getelementptr inbounds nuw [10 x i16], ptr %Array, i16 %Outer.09, i16 %Inner.04, !dbg !90
  %0 = load i16, ptr %arrayidx4, align 2, !dbg !90
  %cmp5 = icmp slt i16 %0, 0, !dbg !93
  br i1 %cmp5, label %if.then, label %if.else, !dbg !93

if.then:                                          ; preds = %for.body3
  %arrayidx7 = getelementptr inbounds nuw [10 x i16], ptr %Array, i16 %Outer.09, i16 %Inner.04, !dbg !94
...
if.else:                                          ; preds = %for.body3
  %arrayidx9 = getelementptr inbounds nuw [10 x i16], ptr %Array, i16 %Outer.09, i16 %Inner.04, !dbg !99
